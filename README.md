> **iSCSI-classic** — the cornerstone of Kurrent's evolution: the iSCSI-only release. Choose this branch for a stable deployment.
...
Storage-node deployment and worker master-image clones are covered by the step-by-step [deployment runbooks](docs/guide/quick-deploy/environment-deploy.md).
...
All documentation lives as Markdown in this repository:

- [Quick Deploy Runbooks](docs/guide/quick-deploy/environment-deploy.md) — environment setup, Windows & Debian master-image clones
- [API Reference](docs/guide/api/control-plane-api.md) — full endpoint contracts
- [Exploration](docs/guide/exploration/architecture.md) — architecture deep-dives
