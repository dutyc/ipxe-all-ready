...
**iPXE-All-Ready** 是一套基于纯开源工具链（iPXE + iSCSI）构建的企业级无状态（Stateless）计算节点交付平台：无本地硬盘的算力节点插网线即可网络启动，无需人工预注册，无厂商锁定。
...
最终目标：构建跨平台、跨架构、云原生的无状态计算基础设施底座。完整的阶段规划（Phase 1~4）与近期推进事项见 **[ROADMAP.md](./ROADMAP.md)**。
